...
?>
    ...
    <body>
        ...
        <ul class="nav nav-tabs navbar-fixed-top">
          ...
          <li role="presentation"><a href="../view/view.penilaian.php">Penilaian</a></li>
          <li role="presentation"><a href="#">Hasil</a></li>
          <li class="pull-right"><a href="../logout.php?logout=true"><span class="glyphicon glyphicon-log-out"></span>&nbsp;lLogout</a></li>
        </ul>
